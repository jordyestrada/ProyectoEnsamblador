...
.data
    ; Incluir archivo de mapa
    include mapa.inc
    
    ; Incluir variables de sprites
    include personajes.inc
    ...
    ; Doble Buffer - banderas para controlar dibujado
    screen_dirty db 1       ; 1 = necesita redibujar, 0 = no redibujar
    last_px db 2            ; Última posición X del jugador
    last_py db 1            ; Última posición Y del jugador
    last_camera_x db 0      ; Última posición X de cámara
    last_camera_y db 0      ; Última posición Y de cámara
...
camera_changed:
    ; Redibujar todo si la cámara cambió
    call clear_and_draw
